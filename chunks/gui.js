...
console.log("18", _index_css__WEBPACK_IMPORTED_MODULE_9___default.a);
document.body.appendChild(appTarget);
if (Object(_lib_supported_browser__WEBPACK_IMPORTED_MODULE_8__["default"])()) {
  console.log("132", appTarget);
  debugger;
...
/*
渲染 GUI 游戏场地。这是一个单独的函数，因为导入任何
 * 会导致不支持的浏览器崩溃。
 * {object} appTarget - 要渲染的 DOM 元素
...
/* harmony default export */ __webpack_exports__["default"] = (function (appTarget) {
  ...
  // 请注意，redux 的 "compose "函数只是作为一个通用工具使用，以使
  // HOC 构造函数调用的层次结构更加清晰；它与 redux 的
  // 编译减速器的能力无关。
  ...
  // TODO 测试背包的黑客程序，允许通过 url 参数设置背包主机
  ...
  if (false) {}
  console.log("71", simulateScratchDesktop);
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(
  // 重要： 这是检查 `simulateScratchDesktop` 是否真实，而不仅仅是定义！
